...
public class Tela extends javax.swing.JFrame {
    ...
    public Tela() {
        initComponents();
        setResizable(false); // bloqueia  o dimensionamento da Tela
    ...
    private void initComponents() {
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon("C:\\Projetos Netbeans\\CadastroSimples\\src\\ico\\User_24x24.png")); // NOI18N
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
        Usuarios_ usuario = null;
        try {
            usuario = new Usuarios_();
        } catch (SQLException ex) {
            Logger.getLogger(Tela.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.jDesktopPane1.add(usuario);
        usuario.setVisible(rootPaneCheckingEnabled);
